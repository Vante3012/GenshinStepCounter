...
public class ActiveQuestScreen extends AppCompatActivity implements SensorEventListener {
    ...
    public void popupQuestComplete() {
        ...
        popupView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                ActiveQuestScreen.this.startActivity(QuestEndScreen);
                return true;
            }
        });
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //NOTE: Values above should be pulled from "Quest Select" Activity with Intent or DB!
